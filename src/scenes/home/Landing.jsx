...
const Landing = ({ setSelectedPage, selectedPage }) => {
    ...
    const titleLines = ["Website Profesional"]
    ...
    const services = [
        {
            ...
            description: "Website dan aplikasi web kustom yang dibangun dengan teknologi modern",
            icon: Globe,
        ...
        },
        {
            id: 2,
            title: "Toko Online",
            description: "Toko online lengkap dengan integrasi pembayaran dan manajemen inventori",
            icon: ShoppingCart,
        ...
        },
        {
            ...
            description: "Optimasi SEO, manajemen media sosial, dan iklan online",
            icon: TrendingUp,
        ...
        },
        {
            id: 4,
            title: "Solusi Cloud",
            description: "Infrastruktur cloud yang dapat diskalakan dan layanan deployment",
            icon: Cloud,
                ...
                <div className="text-center mb-6 xs:mb-8 sm:mb-4">
                    ...
                    <div className="mb-6">
                        <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold leading-tight">
                            <span className="text-white block mb-2">Jasa Pembuatan</span>
                            <div className="bg-gradient-rainblue bg-clip-text text-transparent">
                                ...
                                {currentLine >= 1 && <div>Website Profesional</div>}
                            </div>
                        </h1>
                    </div>
                    ...
                    >
                        <div className="flex items-center justify-center gap-4">
                            ...
                            <div className="flex items-center justify-center gap-2">
                                ...
                                <p className="text-[12px] xs:text-sm text-grey font-medium">Gratis Konsultasi</p>
                            </div>
                        </div>
                    </motion.div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-400 text-[12px] xs:text-sm leading-relaxed">{service.description}</p>
                                    </div>
                                </motion.div>
                            )
                        })}
