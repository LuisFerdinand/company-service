...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
    ...
    const navItems = [
        { id: "home", label: "Beranda", icon: HiHome },
        { id: "about", label: "Tentang", icon: HiUser },
        { id: "workflow", label: "Alur Kerja", icon: HiLightningBolt },
        { id: "services", label: "Layanan", icon: HiCog },
        { id: "projects", label: "Proyek", icon: HiBriefcase },
        { id: "contact", label: "Kontak", icon: HiMail },
    ]
                    ...
                    return (
                        <div key={item.id} className="relative group">
                            ...
                            >
                                ...
                                {isActive && (
                                    <div
                                        className="absolute -inset-0.5 rounded-xl bg-gradient-to-r from-blue via-purple to-blue animate-spin opacity-75"
